...
.then((data) => {
  ...
  data[0].healthLabels.forEach( item =>{
        ...
        healthLabelButtons += `<button type="button" style="background-color: rgb(255, 132, 0);border:1px solid black; color:white;font-size:15px" class="btn m-2">${item}</button>`;
  });
